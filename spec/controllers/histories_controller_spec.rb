...
describe HistoriesController do
  ...
  describe "GET 'show'" do
    before do
      ...
      controller.stub_chain(:history_accessible_pages, :find).with(@page.to_param).and_return(@page)
  ...
  describe "GET 'diff'" do
    before do
      ...
      controller.stub_chain(:history_accessible_pages, :find).with(@page.to_param, anything()).and_return(@page)
    end
    it "should be successful" do
